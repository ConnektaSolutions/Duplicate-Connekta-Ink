      ...
      <div className="flex lg:flex-row flex-col justify-center 2xl:max-w-[80%] w-full lg:gap-16 items-center mt-12">
        ...
        <div className="flex flex-col items-center text-center">
          <div className="relative flex-none">
            ...
            <h3 className="hidden lg:block min-[1320px]:text-[25px] text-[24px] font-semibold uppercase text-black">
              {t("serviceDetails.strategicCommunications.title")}
            </h3>
          </div>
        </div>
        ...
        <div className="space-y-4 xl:text-base text-[14px]">
          ...
          <p>{t("serviceDetails.strategicCommunications.description1")}</p>
          <p>{t("serviceDetails.strategicCommunications.description2")}</p>
          <p>{t("serviceDetails.strategicCommunications.description3")}</p>
          <p>{t("serviceDetails.strategicCommunications.description4")}</p>
          <p>{t("serviceDetails.strategicCommunications.description5")}</p>
          <p>{t("serviceDetails.strategicCommunications.description6")}</p>
        </div>
      </div>
    </section>
  );
